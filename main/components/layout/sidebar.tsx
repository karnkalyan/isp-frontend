    ...
    items: [
      {
        ...
        icon: Package,
        submenu: [
          { title: "Assign Inventory", href: "/inventory/assign" },
          { title: "Add Inventory", href: "/inventory/add" },
          { title: "Bulk Inventory", href: "/inventory/bulk" },
          { title: "Import Inventory", href: "/inventory/import" },
          { title: "Device Lifecycle", href: "/inventory/lifecycle" },
          { title: "Vendor", href: "/inventory/vendor" },
        ],
      },
      {
        title: "Location Mgmt",
