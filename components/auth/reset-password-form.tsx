...
export default function ResetPasswordForm() {
  ...
  return (
    <CardContainer title="Choose New Password" gradientColor="#10b981" className="rounded-xl shadow-lg">
      <form onSubmit={submit} className="space-y-5">
        ...
        {!token && <p className="text-sm text-destructive">The reset token is missing. Request a new link.</p>}
