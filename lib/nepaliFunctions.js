export const NepaliFunctions = (function () {
    "use strict";
    var e = [
        "MM-DD-YYYY",
        "MM/DD/YYYY",
    ...
    function r() {
      ...
      (e[1970] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30]),
        ...
        (e[2081] = [31, 31, 32, 32, 31, 30, 30, 30, 29, 30, 29, 31]),
  ...
  export function formatDateToNepali(dateString) {
    if (!dateString) return "";
    const d = new Date(dateString);
    if (isNaN(d.getTime())) return dateString;
    try {
      const adDate = { year: d.getFullYear(), month: d.getMonth() + 1, day: d.getDate() };
      const bsDate = NepaliFunctions.AD2BS(adDate);
      return NepaliFunctions.ConvertDateFormat(bsDate, "DD/MM/YYYY");
    } catch (e) {
      console.error(e);
      return dateString;
    }
