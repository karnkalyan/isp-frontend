                      ...
                      {expandedLogId === log.id && (
                        <tr>
                          <td colSpan={6} className="bg-slate-50/50 dark:bg-slate-900/30 p-4 border-t border-b border-slate-150 dark:border-slate-800">
                            <div className="space-y-2">
                              <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Metadata details:</span>
                              <pre className="bg-slate-100 dark:bg-slate-950 p-3 rounded-lg overflow-x-auto text-xs font-mono border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200">
                                {(() => {
                                  try {
